...
try {
	...
	if (init('action') == 'changeIncludeState') {
		ArubaIot::changeIncludeState(init('state'), init('type'), init('unclassified_with_local'), init('unclassified_with_mac'), init('unclassified_mac_prefix'), init('unclassified_max_devices'));
		ajax::success();
	}
