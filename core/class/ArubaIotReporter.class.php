...
class ArubaIotReporter extends eqLogic {
    ...
    /*
      ...
      {
        log::add('ArubaIotReporter', 'debug', 'MAC is empty, change to 00:00:00:00:00:00');
...
class ArubaIotReporterCmd extends cmd {
    /*     * *************************Attributs****************************** */
    ...
    public function execute($_options = array()) {
        ...
        log::add('ArubaIotReporter', 'info',  "Commande reçue !");
